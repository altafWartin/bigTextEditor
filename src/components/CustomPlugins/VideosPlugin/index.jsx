...
const getDOMSelection = (targetWindow) =>
  ...
  export function InsertVideoUriDialogBody({ onClick }) {
    ...
    return (
      <>
        <TextField
          label="Video URL"
          placeholder="i.e. https://www.youtube.com/watch?v=yourvideoid"
  ...
  export function InsertVideoUploadedDialogBody({ onClick }) {
    const [src, setSrc] = useState("");
  const [altText, setAltText] = useState("");
